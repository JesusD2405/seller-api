...
{	
	...
	*/
	...
	{
		const _function = new qualityControlEndPoints();
	...
	*
	*	Leer más.. https://sellerapi.sellercenter.net/docs/getqcstatus
	*/

	public async getQcStatus(req: Request, res: Response): Promise<void>{

		const _function = new qualityControlEndPoints();
		const _params   = _function.setParams('GetQcStatus');
	...
	*/
	...
	public routes(){
		...
		this.router.get('/QcStatus',  		this.getQcStatus);

	}
}

const indexRoutes = new qualityControlEndPoints();
